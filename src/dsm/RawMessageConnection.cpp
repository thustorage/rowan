#include "dsm/RawMessageConnection.h"
...
void RawMessageConnection::sendRawMessage(RpcMessage *m, uint32_t remoteQPN,
                                          ibv_ah *ah) {
...
void RawMessageConnection::sendRawMessageWithData(RpcMessage *m, Slice data,
                                                  uint32_t data_lkey,
                                                  uint32_t remoteQPN,
                                                  ibv_ah *ah) {
